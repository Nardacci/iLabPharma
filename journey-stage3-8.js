      ...
      <section class="stage1-screen">
        ...
        <div class="stage1-layout">
          ...
          <main class="stage1-main">
            ...
            <div class="stage1-bottom"><button class="ghost-btn" onclick="renderJourney(${index-1})">← Voltar</button><div><span>Você está aqui</span><strong>${s.name}</strong></div><button class="primary-btn" onclick="renderJourney(${index+1})">${index===7?'Concluir jornada →':'Continuar →'}</button></div>
          </main>
        </div>
      </section>`;
  }
