      ...
      <section class="stage1-screen">
        ...
        <div class="stage1-layout">
          ...
          <main class="stage1-main">
            ...
            ${index===2?'<div class="stage1-prep-description"><p>A etapa de Preparação reúne as condições que devem ser consideradas antes do início da fabricação. Nesse momento, é necessário verificar se os equipamentos que serão utilizados estão qualificados e limpos, se os instrumentos aplicáveis possuem calibrações válidas, se as manutenções previstas estão em dia e se as salas destinadas ao processo estão liberadas para utilização. A avaliação conjunta dessas condições permite confirmar que a estrutura, os equipamentos e os ambientes estão preparados para a operação produtiva prevista. Ao final dessa etapa, o medicamento estará definido tecnicamente para seguir para a fabricação.</p></div>':''}
