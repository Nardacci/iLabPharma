      ...
      <section class="stage1-screen">
        ...
        <div class="stage1-layout">
          ...
          <main class="stage1-main">
            ...
            ${index===2?'<div class="stage1-prep-description"><span class="stage1-prep-label">CONTEXTO DA ETAPA</span><div class="stage1-prep-copy"><p>A etapa de <strong>Preparação</strong> reúne as condições que devem ser consideradas antes do início da fabricação. Nesse momento, é necessário verificar se os <strong>equipamentos que serão utilizados estão qualificados e limpos</strong>, se os <strong>instrumentos aplicáveis possuem calibrações válidas</strong>, se as <strong>manutenções previstas estão em dia</strong> e se as <strong>salas destinadas ao processo estão liberadas para utilização</strong>.</p><p>A avaliação conjunta dessas condições permite confirmar que a estrutura, os equipamentos e os ambientes estão preparados para a operação produtiva prevista.</p><p class="stage1-prep-conclusion">Ao final desta etapa, <strong>o medicamento estará definido tecnicamente para seguir para a fabricação.</strong></p></div></div>':''}
