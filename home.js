  ...
  app.innerHTML=`<section class="journey-intro">
    <header class="journey-intro-header">
      ...
      <div class="journey-intro-actions">
        ...
        <button class="journey-login-btn" onclick="renderPlaceholder('Acesso')"><span>♙</span> Entrar</button>
      </div>
    </header>
